...
class MainWindow:
    def __init__(self):
        ...
        self.uic.btn_closeApp.clicked.connect(self.closeApp)
    ...
    def loadCamQR(self):
        self.cam_0 = cv2.VideoCapture(1)
        self.cam_1 = cv2.VideoCapture(2)
        ...
        while True:
            try:
                    ...
                    if checked_ma_qr == True:
                        ...
                        while(self.cam_0.isOpened()):
                            ...
                            if(trang_thai_gui == 0):
                                ...
                                img_name_truoc = "C:\\project_qrcode\\img\\gui_xe_vao\\"+ma_qr+"_0.png"
                                img_name_sau = "C:\\project_qrcode\\img\\gui_xe_vao\\"+ma_qr+"_1.png"
                                ...
                                if limit_count == 1:
                                    ...
                                    self.uic.label_anhTruocXeRa.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
                                    self.uic.label_anhSauXeRa.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
                            ...
                            #TRUONG HOP 2: DA co xe trong bai
                                ...
                                ret0, frame_truoc = self.cam_1.read()
                                ret1, frame_sau = self.cam_2.read()
                                img_name_truoc = "C:\\project_qrcode\\img\\gui_xe_ra\\"+ma_qr+"_0.png"
                                img_name_sau = "C:\\project_qrcode\\img\\gui_xe_ra\\"+ma_qr+"_1.png"
                                cv2.imwrite(img_name_truoc, frame_truoc)
                                cv2.imwrite(img_name_sau, frame_sau)
                                winsound.Beep(frequency1, duration)
                                ...
                                if limit_count == 1:
                                    ...
                                    temp1 = 'C:\\project_qrcode\\img\\gui_xe_vao\\'+ma_qr+'_0.png'
                                    temp2 = 'C:\\project_qrcode\\img\\gui_xe_vao\\'+ma_qr+'_1.png'
                ...
                self.frame_so_1 = cv2.cvtColor(self.frame_so_1, cv2.COLOR_BGR2RGB)
                self.frame_so_2 = cv2.cvtColor(self.frame_so_2, cv2.COLOR_BGR2RGB)
                self.update()
    ...
    def update(self):
        self.setPhoto(self.frame_so_0, self.frame_so_1, self.frame_so_2 )    

    def setPhoto(self,image0, image1, image2):
        image0 = cv2.resize(image0,(331,251))
        img0 = QtGui.QImage(image0,image0.shape[1],image0.shape[0], image0.strides[0],QtGui.QImage.Format_RGB888)
        self.uic.label_khungCamQR.setPixmap(QtGui.QPixmap.fromImage(img0))

        image1 = cv2.resize(image1,(331,251))
        img1 = QtGui.QImage(image1,image1.shape[1],image1.shape[0], image1.strides[0],QtGui.QImage.Format_RGB888)
        self.uic.label_khungCamTruoc.setPixmap(QtGui.QPixmap.fromImage(img1))

        image2 = cv2.resize(image2,(331,251))
        img2 = QtGui.QImage(image2,image2.shape[1],image2.shape[0], image2.strides[0],QtGui.QImage.Format_RGB888)
        self.uic.label_khungCamSau.setPixmap(QtGui.QPixmap.fromImage(img2))       
    ...
    def getDataFromDB(self,ma_qr,stt):            
        if mydb.is_connected():
            ...
            hoten = myresult1[0][1]
            loaiXe =  myresult1[0][13]
            mauXe =  myresult1[0][15]
    ...
    def clearData(self):
        self.uic.label_anhTruocXeVao.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
        self.uic.label_anhSauXeVao.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
        self.uic.label_anhTruocXeRa.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
        self.uic.label_anhSauXeRa.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))        
        ...
        self.uic.label_anhNguoiDK.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
        self.uic.label_anhXe.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
