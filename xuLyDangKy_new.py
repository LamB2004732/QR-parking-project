...
class MainWindow:
    ...
    def __init__(self):
        ...
        self.uic.label_qr.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))        
    ...
    def clear_input(self):
        self.uic.label_user.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\user_icon.png"))
        self.uic.label_xe.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\moto_icon.png"))
        self.uic.label_qr.setPixmap(QPixmap("C:\\project_qrcode\\img\\sample\\anh_mau_xam.jpg"))
    ...
    def tao_QrCode(self):
        if self.check_information() == 10:
            ...
            img.save("C:\\project_qrcode\\img\\user\\"+maQr+".png")
            anh_user = ""
            anh_xe = ""
            try:
            ...
            #mo hinh anh QRcode len
                self.uic.label_qr.setPixmap(QPixmap("C:\\project_qrcode\\img\\user\\"+maQr+".png"))
